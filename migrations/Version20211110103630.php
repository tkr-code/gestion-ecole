 ...
 */
final class Version20211110103630 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE professeur ADD CONSTRAINT FK_17A55299A21BD112 FOREIGN KEY (personne_id) REFERENCES personne (id)');
